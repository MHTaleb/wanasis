...
public class ServerNodeCodeStartup {
	...
	public static void main(String[] args) throws Exception {
		...
		while (!igniteCluster.active()) {
			System.out.println(
					"waiting for cluster startup please go to control.sh in ignite grid gain server and launch \n"
		...
		ThreadGroup threadGroup = new ThreadGroup("caching threads");
		System.out.println(">>> Loading caches...");

		Thread AdUserCacheThread = new Thread(threadGroup, "AdUserCache") {
			long start, end = 0;
		...
		Thread CBpartnerCacheThread = new Thread(threadGroup, "CBpartnerCache") {
			long start, end = 0;
		...
		Thread CInvoiceCacheThread = new Thread(threadGroup, "CInvoiceCache") {
			long start, end = 0;
		...
		Thread CInvoicelineCacheThread = new Thread(threadGroup, "CInvoicelineCache") {
			long start, end = 0;
		...
		Thread COrderCacheThread = new Thread(threadGroup, "COrderCache") {
			long start, end = 0;
		...
		Thread COrderlineCacheThread = new Thread(threadGroup, "COrderlineCache") {
			long start, end = 0;
		...
		Thread MAttributeCacheThread = new Thread(threadGroup, "MAttributeCache") {
			long start, end = 0;
		...
		Thread MAttributeinstanceCacheThread = new Thread(threadGroup, "MAttributeinstanceCache") {
			long start, end = 0;
		...
		Thread MInoutCacheThread = new Thread(threadGroup, "MInoutCache") {
			long start, end = 0;
		...
		Thread MInoutlineCacheThread = new Thread(threadGroup, "MInoutlineCache") {
			long start, end = 0;
		...
		Thread MProductCacheThread = new Thread(threadGroup, "MProductCache") {
			long start, end = 0;
		...
		Thread XxListetauxvaleurCacheThread = new Thread(threadGroup, "XxListetauxvaleurCache") {
			long start, end = 0;
		...
		AdUserCacheThread.start();
		startedThreads++;
		CBpartnerCacheThread.start();
		startedThreads++;
		CInvoiceCacheThread.start();
		startedThreads++;
		CInvoicelineCacheThread.start();
		startedThreads++;
		COrderCacheThread.start();
		startedThreads++;
		COrderlineCacheThread.start();
		startedThreads++;
		MAttributeCacheThread.start();
		startedThreads++;
		MAttributeinstanceCacheThread.start();
		startedThreads++;
		MInoutCacheThread.start();
		startedThreads++;
		MInoutlineCacheThread.start();
		startedThreads++;
		MProductCacheThread.start();
		startedThreads++;
		XxListetauxvaleurCacheThread.start();
		startedThreads++;
		
		int seconds = 0;
		while ( endedThreads < startedThreads) {
			Thread.sleep(10000);
			seconds+=10;
			System.out.println("total time since start "+seconds);
		}
